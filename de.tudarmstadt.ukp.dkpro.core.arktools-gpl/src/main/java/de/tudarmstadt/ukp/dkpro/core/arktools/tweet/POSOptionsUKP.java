...
public class POSOptionsUKP {
    
    private static Logger log = Logger.getLogger(SemiSupervisedPOSTaggerUKP.class.getCanonicalName());
    ...
    @Option(gloss = "Embeddings file")
    public CmdLineParser.Option embeddingsFile;

    @Option(gloss = "Names file")
    public CmdLineParser.Option namesFile;
    ...
    public POSOptionsUKP(String[] args) {
        ...
        embeddingsFile = parser.addStringOption("embeddingsFile");
        namesFile = parser.addStringOption("namesFile");
