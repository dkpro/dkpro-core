...
import static org.dkpro.core.io.tei.internal.TeiP4Constants.ATTR_POS;
...
import static org.dkpro.core.io.tei.internal.TeiP4Constants.TAG_MULTIWORD;
import static org.dkpro.core.io.tei.internal.TeiP4Constants.TAG_PARAGRAPH;
import static org.dkpro.core.io.tei.internal.TeiP4Constants.TAG_PERS_NAME;
...
import static org.dkpro.core.io.tei.internal.TeiP4Constants.TAG_TEI_DOC;
import static org.dkpro.core.io.tei.internal.TeiP4Constants.TAG_TEXT;
import static org.dkpro.core.io.tei.internal.TeiP4Constants.TAG_TITLE;
import static org.dkpro.core.io.tei.internal.TeiP4Constants.TAG_U;
 ...
 * </table>
 */
@ResourceMetaData(name = "TEI P4 XML Reader")
    ...
    private void nextTeiElement() throws CollectionException, IOException
    {
        ...
        while (!teiElementIterator.hasNext() && super.hasNext()) {
            ...
            try {
                ...
                final XPath teiPath = new Dom4jXPath("//TEI.2");
...
//            System.out.printf("%b START %s %n", captureText, aLocalName);
            if (!inTextElement && TAG_TEI_DOC.equals(aName)) {
                ...
                if (paragraphStart != -1) {
                    throw new SAXException("Nested paragraphs are not supported");
                }
            ...
            else if (readNamedEntity && inTextElement && TAG_PERS_NAME.equals(aName)) {
                NamedEntity ne = new NamedEntity(getJCas());
                ne.setBegin(getBuffer().length());
                ne.setValue("PER");
                namedEntities.push(ne);
