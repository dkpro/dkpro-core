    ...
    extends CasAnnotator_ImplBase
{
    ...
    {
        private final File overrideModelPath;
        private final String overrideModelEncoding;
            ...
            throws IOException
        {
            ...
            if (modelFile != null) {
                ...
                properties = PropertiesLoaderUtils.loadProperties(new FileSystemResource(
                        propertiesFile));
            }
            ...
            if (modelFile == null) {
                ...
                if (modelUrl != null) {
                    ...
                    if (propertiesUrl == null) {
                        throw new IOException("There is no properties file for model ["
                                + aModelName + "] at [" + propertiesLoc + "]");
                    }

                    properties = PropertiesLoaderUtils
                            .loadProperties(new UrlResource(propertiesUrl));
                    modelFile = getUrlAsExecutable(modelUrl, true);
                }
            }

            if (modelFile == null || properties == null) {
                throw new IOException("Unable to locate model [" + aModelName
                        + "] in the following " + "locations " + searchedIn
