...
<%
def testClass = new File(project.basedir, 
    "../${it.value.module}/src/test/java/${it.value.implName.replaceAll('\\.', '/')}Test.java");
if (testClass.exists() && testClass.text.contains('tag::example[]')) {
%>
