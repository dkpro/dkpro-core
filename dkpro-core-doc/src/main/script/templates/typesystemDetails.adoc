...
[small]#*_URI:_* __http://dkpro.github.io/dkpro-core/releases/${project.version}/docs/typesystem-reference.html#${type.name}__# +
...
typesystemMappings[type.name].externalReferences.each { ref ->
    out.println("[small]#*_${ref.rel}:_* __${ref.id}__ (${ref.source})# +");
}
%>
