...
to maintain a good quality of the descriptions, they may not be perfect. Please use the *Edit on
GitHub* links next to the descriptions in the document below or the 
