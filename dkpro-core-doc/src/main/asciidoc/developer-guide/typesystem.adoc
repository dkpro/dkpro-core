...
----
include::{source-dir}dkpro-core-testing-asl/src/main/java/de/tudarmstadt/ukp/dkpro/core/testing/validation/checks/AllPosAttachedToTokenCheck.java[tags=check-example]
----