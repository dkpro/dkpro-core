...
public class ReplacementFileNormalizerTest
{
    ...
    public void testReplacementNormalizer() throws Exception
    {
        ...
        // testInternetslangReplacement("AKA hdl AKA.", "Also known as Hab' dich lieb Also known
        // as.");
    }

    public void testEmoticonReplacement(String input, String output) throws Exception
    {
        AnalysisEngineDescription replace = createEngineDescription(ReplacementFileNormalizer.class,
                ReplacementFileNormalizer.PARAM_MODEL_LOCATION,
                "src/main/resources/replaceLists/emoticons_de.txt",
    ...
    public void testInternetslangReplacement(String input, String output) throws Exception
    {
        AnalysisEngineDescription replace = createEngineDescription(ReplacementFileNormalizer.class,
                ...
                ReplacementFileNormalizer.PARAM_SRC_SURROUNDINGS,
                SrcSurroundings.ONLY_ALPHANIMERIC);
