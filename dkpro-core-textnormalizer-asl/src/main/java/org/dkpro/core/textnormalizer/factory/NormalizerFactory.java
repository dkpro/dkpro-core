...
import org.dkpro.core.textnormalizer.ReplacementFileNormalizer;
...
import org.dkpro.core.textnormalizer.SpellingNormalizer;
import org.dkpro.core.textnormalizer.frequency.CapitalizationNormalizer;
import org.dkpro.core.textnormalizer.frequency.ExpressiveLengtheningNormalizer;
import org.dkpro.core.textnormalizer.frequency.SharpSNormalizer;
...
public class NormalizerFactory
{
        ...
        throws ResourceInitializationException
    {
        ...
        ab.add(createEngineDescription(BreakIteratorSegmenter.class), CAS.NAME_DEFAULT_SOFA,
                getSourceView());
        ab.add(createEngineDescription(JazzyChecker.class, JazzyChecker.PARAM_MODEL_LOCATION,
                aModelLocation), CAS.NAME_DEFAULT_SOFA, getSourceView());
        ab.add(createEngineDescription(SpellingNormalizer.class), CAS.NAME_DEFAULT_SOFA,
                getSourceView());
    ...
    {
        AggregateBuilder ab = new AggregateBuilder();
        ab.add(createEngineDescription(ReplacementFileNormalizer.class,
