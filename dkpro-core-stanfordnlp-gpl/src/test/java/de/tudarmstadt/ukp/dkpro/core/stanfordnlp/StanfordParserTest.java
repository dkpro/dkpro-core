...
public class StanfordParserTest
{
    ...
    private static final String[] SPANISH_POS_TAGS = { ".$$.", "359000", "NCMS000", "ac0000",
            "ao0000", "ap0000", "aq0000", "aqs000", "cc", "cs", "d00000", "da0000", "dd0000",
            "de0000", "di0000", "dn0000", "do0000", "dp0000", "dt0000", "f0", "faa", "fat", "fc",
            "fca", "fct", "fd", "fe", "fg", "fh", "fi", "fia", "fit", "fp", "fpa", "fpt", "fra",
            "frc", "fs", "fsa", "ft", "fx", "fz", "i", "nc00000", "nc0a000", "nc0c000", "nc0n000",
        ...
        throws Exception
    {
        ...
        String[] dependencies = {
                ...
                "[ 27, 34]NN(nn,basic) D[27,34](example) G[35,43](sentence)",
                "[ 35, 43]DOBJ(dobj,basic) D[35,43](sentence) G[3,7](need)",
                "[ 35, 43]NSUBJ(nsubj,enhanced) D[35,43](sentence) G[52,60](contains)",
                "[ 52, 60]RCMOD(rcmod,basic) D[52,60](contains) G[35,43](sentence)",
                "[ 64, 68]AMOD(amod,basic) D[64,68](many) G[69,81](constituents)",
                "[ 69, 81]PREP(prep_as,basic) D[69,81](constituents) G[52,60](contains)",
                "[ 86, 98]CONJ(conj_and,basic) D[86,98](dependencies) G[69,81](constituents)",
        ...
        throws Exception
    {
        ...
        String[] dependencies = {
                ...
                "[ 15, 16]PUNCT(punct,basic) D[15,16](.) G[10,14](test)" };
        ...
        throws Exception
    {
        ...
        assertDependencies(dependencies, select(jcas, Dependency.class));
        assertPennTree(pennTree, selectSingle(jcas, PennTree.class));
        assertTagset(POS.class, "ancora", posTags, jcas);
        assertTagsetMapping(POS.class, "ancora", unmappedPos, jcas);
