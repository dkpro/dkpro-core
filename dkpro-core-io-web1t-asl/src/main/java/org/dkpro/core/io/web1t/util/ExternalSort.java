 ...
 *
 * By (in alphabetical order) Philippe Beaudoin, Jon Elsas, Christan Grant, Daniel Haran, Daniel
 * Lemire, April 2010 originally posted at
...
public class ExternalSort
{
     ...
     *             if an I/O problem occurs.
     */
    public static List<File> sortInBatch(File file, Comparator<String> cmp, int maxtmpfiles)
        throws IOException
    {
