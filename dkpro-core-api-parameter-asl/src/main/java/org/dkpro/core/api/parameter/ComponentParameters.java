...
public final class ComponentParameters
{
    ...
    /**
     * Variant of the model. Used to address a specific model if here are multiple models for one
     * language.
     */
    ...
    /**
     * Regex to filter tags, e. g. named entities. Used by, e. g, named entity, trainers to train a
     * model for just one model variant.
     */
     ...
     * <ul>
     * <li>for positive values: use the given number of threads, with the number of available CPUs
     * maximum.</li>
     * <li>for negative value: use the number of available CPUs minus the given value, minimum
     * 1.</li>
     * <li>for {@link #AUTO_NUM_THREADS} (0): use the number of available CPUs minus one.</li>
     * </ul>
     *
     * @param value
     *            the user-proposed number of threads (positive, negative, or 0)
     ...
     */
    public static final String PARAM_NAMED_ENTITY_MAPPING_LOCATION = NAMED_ENTITY
            + MAPPING_LOCATION;
