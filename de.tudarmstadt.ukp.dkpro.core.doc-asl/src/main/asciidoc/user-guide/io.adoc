...
|TokenizedTextWriter (FW)|Write one sentence per line with whitespace-separated tokens (or lemmas, or any other annotations) to a file (suitable as input to word2vec)
|====
