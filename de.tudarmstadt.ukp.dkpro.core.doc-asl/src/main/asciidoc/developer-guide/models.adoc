...
This code also uses a mapping provider to translate tags produced by the tagger to UIMA types. See
the <<sect_mapping_providers,section on mapping providers>> for more details.
