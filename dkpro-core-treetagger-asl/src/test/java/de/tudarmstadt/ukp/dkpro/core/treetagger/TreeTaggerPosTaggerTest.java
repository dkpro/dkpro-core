...
class TreeTaggerPosTaggerTest
{
    ...
    public void testBulgarian()
        throws Exception
    {
		String[] tagset = { "A", "A-pd", "A-pi", "Afsd", "Afsh", "Afsi", "Ams-d", "Ams-e", "Amsf", "Amsh", "Amsi",
				"Ansd", "Ansi", "Cc", "Cp", "Cr", "Cs", "D", "Dd", "Dl", "Dm", "Dq", "Dt", "H-pi", "Hfsd", "Hfsi",
				"Hmsf", "Hmsi", "Hnsi", "I", "Mc--d", "Mc--i", "Mc-pd", "Mc-pi", "Mcf-d", "Mcf-i", "Mcfpd", "Mcfpi",
				"Mcfsd", "Mcfsi", "Mcm-i", "Mcmpd", "Mcmpi", "Mcmsf", "Mcmsi", "Mcn-d", "Mcn-i", "Mcnpd", "Mcnpi",
				"Mcnsd", "Mcnsi", "Md--d", "Md--i", "Md-pd", "Md-pi", "Mo-pd", "Mo-pi", "Mofsd", "Mofsi", "Momsf",
				"Momsh", "Momsi", "Monsd", "Monsi", "My-pi", "N", "Nc-ld", "Nc-li", "Ncfpd", "Ncfpi", "Ncfs-v", "Ncfsd",
				"Ncfsi", "Ncmpd", "Ncmpi", "Ncms-v", "Ncmsd", "Ncmsf", "Ncmsh", "Ncmsi", "Ncmt", "Ncnpd", "Ncnpi",
				"Ncnsd", "Ncnsi", "Nmct", "Np", "Np-li", "Np-pd", "Np-pi", "Np-si", "Npfpd", "Npfpi", "Npfsd", "Npfsi",
				"Npmpd", "Npmpi", "Npms-a", "Npms-v", "Npmsd", "Npmsf", "Npmsh", "Npmsi", "Npnpd", "Npnpi", "Npnsd",
				"Npnsi", "PT", "PT_SENT", "Pca--p", "Pca--s-f", "Pca--s-m", "Pca--s-n", "Pce-as-m", "Pce-op",
				"Pce-os-f", "Pce-os-m", "Pce-os-n", "Pcl", "Pcq--p--d", "Pcq--s-nd", "Pct", "Pda--p", "Pda--s-f",
				"Pda--s-m", "Pda--s-n", "Pde-op", "Pde-os-f", "Pde-os-m", "Pde-os-n", "Pdl", "Pdm", "Pdq", "Pds", "Pdt",
				"Pfa--p", "Pfa--s-f", "Pfa--s-m", "Pfa--s-n", "Pfe-as-m", "Pfe-ds-m", "Pfe-op", "Pfe-op--d",
				"Pfe-op--i", "Pfe-os-f", "Pfe-os-fd", "Pfe-os-fi", "Pfe-os-m", "Pfe-os-mf", "Pfe-os-mh", "Pfe-os-mi",
				"Pfe-os-n", "Pfe-os-nd", "Pfe-os-ni", "Pfl", "Pfm", "Pfp--p", "Pfp--s-n", "Pfq-----i", "Pft",
				"Pfy-----i", "Pia--p", "Pia--s-f", "Pia--s-m", "Pia--s-n", "Pic", "Pie-as-m", "Pie-o", "Pie-op",
				"Pie-os-f", "Pie-os-m", "Pie-os-n", "Pil", "Pim", "Pip--s-f", "Pip--s-m", "Piq", "Pit", "Pna--p",
				"Pna--s-f", "Pna--s-m", "Pna--s-n", "Pne-as-m", "Pne-ds-m", "Pne-os-f", "Pne-os-m", "Pne-os-n",
				"Pne-os-nd", "Pne-os-ni", "Pnl", "Pnm", "Pnp--s-f", "Pnt", "Ppe-op1", "Ppe-op2", "Ppe-op3", "Ppe-os1",
				"Ppe-os2", "Ppe-os3f", "Ppe-os3m", "Ppe-os3n", "Ppelap1", "Ppelap2", "Ppelap3", "Ppelas1", "Ppelas2",
				"Ppelas3f", "Ppelas3m", "Ppelas3n", "Ppeldp1", "Ppeldp3", "Ppelds1", "Ppelds2", "Ppelds3m", "Ppetap1",
				"Ppetap2", "Ppetap3", "Ppetas1", "Ppetas2", "Ppetas3f", "Ppetas3m", "Ppetas3n", "Ppetdp1", "Ppetdp2",
				"Ppetdp3", "Ppetds1", "Ppetds2", "Ppetds3f", "Ppetds3m", "Ppetds3n", "Ppetsp1", "Ppetsp2", "Ppetsp3",
				"Ppetss1", "Ppetss2", "Ppetss3f", "Ppetss3m", "Pph-os2", "Pphlas2", "Pphtas2", "Pphtds2", "Pphtss2",
				"Ppxla", "Ppxta", "Ppxtd", "Ppxts", "Pra--p", "Pra--s-f", "Pra--s-m", "Pra--s-n", "Pre--s", "Pre-as-m",
				"Pre-ds-m", "Pre-op", "Pre-os-f", "Pre-os-m", "Pre-os-n", "Prl", "Prm", "Prp--p", "Prp--s-f",
				"Prp--s-m", "Prp--s-n", "Prq", "Prs", "Prt", "Pshl-p2-d", "Pshl-p2-i", "Pshl-s2fd", "Pshl-s2fi",
				"Pshl-s2mf", "Pshl-s2mh", "Pshl-s2mi", "Pshl-s2nd", "Pshl-s2ni", "Psht--2", "Psol-p1-d", "Psol-p2-d",
				"Psol-p2-i", "Psol-p3-df", "Psol-p3-dm", "Psol-p3-dn", "Psol-p3-if", "Psol-p3-im", "Psol-s1fd",
				"Psol-s1fi", "Psol-s1mf", "Psol-s1mh", "Psol-s1mi", "Psol-s1nd", "Psol-s1ni", "Psol-s2fd", "Psol-s2fi",
				"Psol-s2nd", "Psol-s2ni", "Psol-s3fdf", "Psol-s3fdm", "Psol-s3fdn", "Psol-s3fif", "Psol-s3fim",
				"Psol-s3mff", "Psol-s3mfm", "Psol-s3mfn", "Psol-s3mhf", "Psol-s3mhm", "Psol-s3mhn", "Psol-s3mif",
				"Psol-s3mim", "Psol-s3min", "Psol-s3ndf", "Psol-s3ndm", "Psol-s3ndn", "Psol-s3nif", "Psol-s3nim",
				"Psol-s3nin", "Psot--1", "Psot--2", "Psot--3--f", "Psot--3--m", "Psot--3--n", "Psxlop--d", "Psxlop--i",
				"Psxlos-fd", "Psxlos-fi", "Psxlos-mh", "Psxlos-mi", "Psxlos-nd", "Psxlos-ni", "Psxto", "Pszl-p1-d",
				"Pszl-p1-i", "Pszl-p2-d", "Pszl-p2-i", "Pszl-p3-d", "Pszl-p3-i", "Pszl-s1fd", "Pszl-s1fi", "Pszl-s1mf",
				"Pszl-s1mh", "Pszl-s1mi", "Pszl-s1nd", "Pszl-s1ni", "Pszl-s2fd", "Pszl-s2fi", "Pszl-s2mh", "Pszl-s2mi",
				"Pszl-s2nd", "Pszl-s2ni", "Pszl-s3fd", "Pszl-s3fi", "Pszl-s3mf", "Pszl-s3mh", "Pszl-s3mi", "Pszl-s3nd",
				"Pszl-s3ni", "Pszt--1", "Pszt--2", "Pszt--3", "R", "T", "Ta", "Te", "Tg", "Ti", "Tm", "Tn", "Tv", "Tx",
				"Viitf-r3p", "Viitf-r3s", "Vniicam-sni", "Vniicao-sni", "Vniif-m3s", "Vniif-o3s", "Vniif-r3s",
				"Vnitcam-sni", "Vnitcao-sni", "Vnitf-m3s", "Vnitf-o3s", "Vnitf-r3s", "Vnpicao-sni", "Vnpif-o3s",
				"Vnpif-r3s", "Vnptcao-sni", "Vpiicam-p-i", "Vpiicam-sfi", "Vpiicam-smi", "Vpiicam-sni", "Vpiicao-p-d",
				"Vpiicao-p-i", "Vpiicao-sfd", "Vpiicao-sfi", "Vpiicao-smf", "Vpiicao-smh", "Vpiicao-smi", "Vpiicao-snd",
				"Vpiicao-sni", "Vpiicar-p-d", "Vpiicar-p-i", "Vpiicar-sfd", "Vpiicar-sfi", "Vpiicar-smf", "Vpiicar-smh",
				"Vpiicar-smi", "Vpiicar-snd", "Vpiicar-sni", "Vpiicv--sni", "Vpiif-m1p", "Vpiif-m1s", "Vpiif-m2p",
				"Vpiif-m2s", "Vpiif-m3p", "Vpiif-m3s", "Vpiif-o1p", "Vpiif-o1s", "Vpiif-o2p", "Vpiif-o2s", "Vpiif-o3p",
				"Vpiif-o3s", "Vpiif-r1p", "Vpiif-r1s", "Vpiif-r2p", "Vpiif-r2s", "Vpiif-r3p", "Vpiif-r3s", "Vpiig",
				"Vpiiz--2p", "Vpiiz--2s", "Vpitcam-p-i", "Vpitcam-sfi", "Vpitcam-smi", "Vpitcam-sni", "Vpitcao-p-d",
				"Vpitcao-p-i", "Vpitcao-sfd", "Vpitcao-sfi", "Vpitcao-smf", "Vpitcao-smh", "Vpitcao-smi", "Vpitcao-snd",
				"Vpitcao-sni", "Vpitcar-p-d", "Vpitcar-p-i", "Vpitcar-sfd", "Vpitcar-sfi", "Vpitcar-smf", "Vpitcar-smh",
				"Vpitcar-smi", "Vpitcar-snd", "Vpitcar-sni", "Vpitcv--p-d", "Vpitcv--p-i", "Vpitcv--sfd", "Vpitcv--sfi",
				"Vpitcv--smf", "Vpitcv--smh", "Vpitcv--smi", "Vpitcv--snd", "Vpitcv--sni", "Vpitf-m1p", "Vpitf-m1s",
				"Vpitf-m2p", "Vpitf-m2s", "Vpitf-m3p", "Vpitf-m3s", "Vpitf-o1p", "Vpitf-o1s", "Vpitf-o2p", "Vpitf-o2s",
				"Vpitf-o3p", "Vpitf-o3s", "Vpitf-r1p", "Vpitf-r1s", "Vpitf-r2p", "Vpitf-r2s", "Vpitf-r3p", "Vpitf-r3s",
				"Vpitg", "Vpitz--2p", "Vpitz--2s", "Vppicam-p-i", "Vppicam-sfi", "Vppicam-smi", "Vppicam-sni",
				"Vppicao-p-d", "Vppicao-p-i", "Vppicao-sfd", "Vppicao-sfi", "Vppicao-smf", "Vppicao-smh", "Vppicao-smi",
				"Vppicao-snd", "Vppicao-sni", "Vppif-m1p", "Vppif-m1s", "Vppif-m2p", "Vppif-m2s", "Vppif-m3p",
				"Vppif-m3s", "Vppif-o1p", "Vppif-o1s", "Vppif-o2p", "Vppif-o2s", "Vppif-o3p", "Vppif-o3s", "Vppif-r1p",
				"Vppif-r1s", "Vppif-r2p", "Vppif-r2s", "Vppif-r3p", "Vppif-r3s", "Vppiz--2p", "Vppiz--2s",
				"Vpptcam-p-i", "Vpptcam-sfi", "Vpptcam-smi", "Vpptcam-sni", "Vpptcao-p-d", "Vpptcao-p-i", "Vpptcao-sfd",
				"Vpptcao-sfi", "Vpptcao-smf", "Vpptcao-smh", "Vpptcao-smi", "Vpptcao-snd", "Vpptcao-sni", "Vpptcv--p-d",
				"Vpptcv--p-i", "Vpptcv--sfd", "Vpptcv--sfi", "Vpptcv--smf", "Vpptcv--smh", "Vpptcv--smi", "Vpptcv--snd",
				"Vpptcv--sni", "Vpptf-m1p", "Vpptf-m1s", "Vpptf-m2p", "Vpptf-m2s", "Vpptf-m3p", "Vpptf-m3s",
				"Vpptf-o1p", "Vpptf-o1s", "Vpptf-o2p", "Vpptf-o2s", "Vpptf-o3p", "Vpptf-o3s", "Vpptf-r1p", "Vpptf-r1s",
				"Vpptf-r2p", "Vpptf-r2s", "Vpptf-r3p", "Vpptf-r3s", "Vpptz--2p", "Vpptz--2s", "Vxitcat-p-i",
				"Vxitcat-sfi", "Vxitcat-smi", "Vxitcat-sni", "Vxitf-r1p", "Vxitf-r1s", "Vxitf-r2p", "Vxitf-r2s",
				"Vxitf-r3p", "Vxitf-r3s", "Vxitf-t1p", "Vxitf-t1s", "Vxitf-t2p", "Vxitf-t2s", "Vxitf-t3p", "Vxitf-t3s",
				"Vxitg", "Vxitu-o1p", "Vxitu-o1s", "Vxitu-o2p", "Vxitu-o2s", "Vxitu-o3p", "Vxitu-o3s", "Vyptf-o3s",
				"Vyptf-r1p", "Vyptf-r1s", "Vyptf-r2p", "Vyptf-r2s", "Vyptf-r3p", "Vyptf-r3s", "Vyptz--2s" };
        
        runTest("bg", "btb", tagset, "Това е тест .",
                new String[] {  "това", "е", "тест", "."   },
                new String[] { "Pde-os-n", "Vxitf-r3s", "Ncmsi", "PT_SENT"   },
