  ...
  */  
  ...
  public String getSyntacticFunction() {
    if (Token_Type.featOkTst && ((Token_Type)jcasType).casFeat_syntacticFunction == null)
      jcasType.jcas.throwFeatMissing("syntacticFunction", "de.tudarmstadt.ukp.dkpro.core.api.segmentation.type.Token");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Token_Type)jcasType).casFeatCode_syntacticFunction);}
  ...
  public void setSyntacticFunction(String v) {
    if (Token_Type.featOkTst && ((Token_Type)jcasType).casFeat_syntacticFunction == null)
      jcasType.jcas.throwFeatMissing("syntacticFunction", "de.tudarmstadt.ukp.dkpro.core.api.segmentation.type.Token");
    jcasType.ll_cas.ll_setStringValue(addr, ((Token_Type)jcasType).casFeatCode_syntacticFunction, v);}    
    /**
