    ...
    extends CasCollectionReader_ImplBase
{
    ...
    /**
     * optional, tags those should be worked on (if empty, then all tags except those ExcludeTags
     * will be worked on)
     */
    ...
    /**
     * optional, tags those should not be worked on. Out them should no text be extracted and also
     * no Annotations be produced.
     */
