...
public class UmlautSharpSNormalizerTest
{
    ...
    public void testUmlautSharpSNormalizer() throws Exception
    {
        ...
        //Check Umlaut normalization
        test("Der Apfel ist sueß", "Der Apfel ist süß");
    ...
    public void test(String sourceText, String targetText) throws Exception
    {
        ...
        builder.add(createEngineDescription(
                UmlautSharpSNormalizer.class,
                UmlautSharpSNormalizer.FREQUENCY_PROVIDER, frequencyProvider,
                UmlautSharpSNormalizer.PARAM_MIN_FREQUENCY_THRESHOLD,0));
