...
public final class SegmenterHarness
{
    public static final TestData[] DATA = new TestData[] {
            ...
            new TestData("en.1", "en", "Sadler, A.L. Cha-No-Yu: The Japanese Tea Ceremony.",
                    new String[] { "Sadler", ",", "A.L.", "Cha-No-Yu", ":", "The", "Japanese",
                            "Tea", "Ceremony", "." },
                    new String[] { "Sadler, A.L. Cha-No-Yu: The Japanese Tea Ceremony." }),
            new TestData("en.2", "en",
                    "I love the UIMA toolkit. 1989 is the year in which the Berlin wall fell.",
                    new String[] { "I", "love", "the", "UIMA", "toolkit", ".", "1989", "is", "the",
                            "year", "in", "which", "the", "Berlin", "wall", "fell", "." },
            ...
            new TestData("en.5", "en", "Georg \"Bullseye\" Logal is a though guy.",
                    new String[] { "Georg", "\"", "Bullseye", "\"", "Logal", "is", "a", "though",
                            "guy", "." },
            ...
            new TestData("en.7", "en",
                    ...
                    new String[] {
                            "based on\n 'Carnival of Souls', written by [...] and directed by [...]." }),
            new TestData("en.8", "en", ", , ,", new String[] { ",", ",", "," },
                    new String[] { ", , ," }),
            new TestData("en.9", "en",
                    "How to tokenize smileys? This is a good example. >^,,^< :0 3:[",
                    new String[] { "How", "to", "tokenize", "smileys", "?", "This", "is", "a",
                            "good", "example.", ">^,,^<", ":0", "3:[" },
                    new String[] { "How to tokenize smileys?", "This is a good example.",
                            ">^,,^< :0 3:[" }),
            ...
            new TestData("ar.1", "ar", "تغطي الصحراء الكبرى الدول التالية بمساحات شاسعة جدا",
                    new String[] { "تغطي", "الصحراء", "الكبرى", "الدول", "التالية", "مساحات",
                            "شاسعة", "جدا" },
            ...
            new TestData("zh.1", "zh", "服务业成为广东经济转型升级的重要引擎。",
                    new String[] { "服务业", "成为", "广东", "经济", "转型", "升级", "的", "重要", "引擎", "。" },
    ...
    {
        void assume(String aLanguage, String aVariant) throws IOException;
    }
        ...
        throws Exception
    {
        ...
        AnalysisEngine ae = createEngine(aSegmenter, SegmenterBase.PARAM_STRICT_ZONING, false,
        ...
        throws Exception
    {
        ...
        // strict zoning
        {
            ...
            AnalysisEngine ae = createEngine(aSegmenter, SegmenterBase.PARAM_STRICT_ZONING, true,
                    SegmenterBase.PARAM_ZONE_TYPES, Paragraph.class);
            ae.process(jcas);
        ...
        throws Exception
    {
        ...
        String[] tokens = { "A", "a", "a", "a", ".", "A", "a", "a", "a", "-", "C", "c", "c", "c",
                ".", "C", "c", "c", "c", "-" };
    ...
    static class TestData
    {
        ...
        public TestData(String aId, String aLanguage, String aText, String[] aTokens,
                String[] aSentences)
        {
            id = aId;
            language = aLanguage;
