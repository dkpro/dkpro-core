	...
	extends JCasAnnotator_ImplBase
{
	...
	/**
	 * Specifies a featurepath that is used in the filter. If this is set, you also have to specify
	 ...
	 *
	 * @see de.tudarmstadt.ukp.dkpro.core.util.featurepath.FilterOp
	 */
	 ...
	 * It is only used if <code>PARAM_FILTER_FEATUREPATH</code> is set.
	 *
	 * @see de.tudarmstadt.ukp.dkpro.core.util.featurepath.Condition
	 */
		...
		throws ResourceInitializationException
	{
		...
		// check if filter featurepath exists, if so, try to build the condition
	...
	protected
	Set<String> getDefaultPaths()
	{
		return null;
	}

	/**
	 * Method that intializes the filter.
	 *
	 * @throws FeaturePathException
	 *             if an error occurs during the initialization of the FeaturePathInfo object.
	 */
	...
	/**
	 * Checks for empty featurepath and initializes the featurepathobject.
	 *
	 * @param aFp
	 *            the featurepath that is to be initialized with the featurePathString
	 * @param featurePathString
	 *            the string that is used to initialize fp
	 * @throws FeaturePathException
	 *             if an error occurs during initialization of the FeaturePathInfo object
	 */
