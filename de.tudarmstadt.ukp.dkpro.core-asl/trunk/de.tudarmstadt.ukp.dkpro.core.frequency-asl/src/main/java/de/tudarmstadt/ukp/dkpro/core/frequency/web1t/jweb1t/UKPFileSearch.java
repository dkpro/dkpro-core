 ...
 * @since		1.0
 */
public class UKPFileSearch implements Search
{
	/**
	 * Define a static logger variable so that it references the
	 * Logger instance named <code>FileSearch</code>.
	 */
	static Logger logger = Logger.getLogger(UKPFileSearch.class.getName());

	private final RandomAccessFile raf;

	public UKPFileSearch(File file) throws IOException
	{
