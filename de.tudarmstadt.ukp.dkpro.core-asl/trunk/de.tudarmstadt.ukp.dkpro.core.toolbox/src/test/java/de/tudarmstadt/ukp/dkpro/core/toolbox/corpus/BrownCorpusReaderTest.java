...
public class BrownCorpusReaderTest
{
        ...
        throws Exception
    {
        ...
        CollectionReader reader = createCollectionReader(
                ...
                BrownCorpusReader.PARAM_WRITE_SENTENCES, false
        );
        ...
        throws Exception
    {
        ...
        CollectionReader reader = createCollectionReader(
                ...
                BrownCorpusReader.PARAM_WRITE_TOKENS, false,
                BrownCorpusReader.PARAM_WRITE_POS, false
        );
        ...
        throws Exception
    {
        ...
        CollectionReader reader = createCollectionReader(
                ...
                BrownCorpusReader.PARAM_WRITE_POS, true,
                BrownCorpusReader.PARAM_WRITE_TOKENS, false
        );
