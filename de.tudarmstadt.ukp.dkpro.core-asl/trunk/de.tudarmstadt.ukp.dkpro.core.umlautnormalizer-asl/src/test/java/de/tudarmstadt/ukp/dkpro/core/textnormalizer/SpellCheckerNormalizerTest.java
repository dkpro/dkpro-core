...
public class SpellCheckerNormalizerTest
{
    ...
    {
	test("ich tesde meiine neue Rechtschreibbeprüfung.", "ich teste meine neue Rechtschreibprüfung.");
...
//	test("LauFEN SCHIEßEN BaföG ÜBERlegen","laufen schießen BAföG überlegen");
	...
	builder.add(createEngineDescription(JazzyChecker.class, JazzyChecker.PARAM_MODEL_LOCATION, "src/test/resources/dictionary/ngerman"));
	builder.add(createEngineDescription(SpellCheckerNormalizer.class));
	builder.add(createEngineDescription(ApplyChangesAnnotator.class), "source", "_InitialView", "target", "spell_checked");
