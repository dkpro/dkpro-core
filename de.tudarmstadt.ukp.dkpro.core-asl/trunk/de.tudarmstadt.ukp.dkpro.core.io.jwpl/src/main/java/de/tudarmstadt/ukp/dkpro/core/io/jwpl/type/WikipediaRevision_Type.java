	...
	extends Annotation_Type
{
	...
	private final FSGenerator fsGenerator = new FSGenerator()
	{
		public FeatureStructure createFS(int addr, CASImpl cas)
		{
			if (WikipediaRevision_Type.this.useExistingInstance) {
				...
				FeatureStructure fs = WikipediaRevision_Type.this.jcas
						.getJfsFromCaddr(addr);
				if (null == fs) {
					fs = new WikipediaRevision(addr,
							WikipediaRevision_Type.this);
				...
				return new WikipediaRevision(addr, WikipediaRevision_Type.this);
			}
		}
	};
	/** @generated */
	...
	public final static boolean featOkTst = JCasRegistry
			.getFeatOkTst("de.tudarmstadt.ukp.dkpro.core.io.jwpl.type.WikipediaRevision");
	...
	public int getRevisionId(int addr)
	{
		if (featOkTst && casFeat_revisionId == null) {
			jcas.throwFeatMissing("revisionId",
	...
	public String getContributorName(int addr)
	{
		if (featOkTst && casFeat_contributorName == null) {
			jcas.throwFeatMissing("contributorName",
					"de.tudarmstadt.ukp.dkpro.core.io.jwpl.type.WikipediaRevision");
		}
	...
	public int getContributorId(int addr)
	{
		if (featOkTst && casFeat_contributorId == null) {
			jcas.throwFeatMissing("contributorId",
					"de.tudarmstadt.ukp.dkpro.core.io.jwpl.type.WikipediaRevision");
		}
	...
	public long getTimestamp(int addr)
	{
		if (featOkTst && casFeat_timestamp == null) {
			jcas.throwFeatMissing("timestamp",
					"de.tudarmstadt.ukp.dkpro.core.io.jwpl.type.WikipediaRevision");
		}
	...
	public WikipediaRevision_Type(JCas jcas, Type casType)
	{
		...
		casFeat_revisionId = jcas.getRequiredFeatureDE(casType, "revisionId",
				"uima.cas.Integer", featOkTst);
		casFeatCode_revisionId = (null == casFeat_revisionId) ? JCas.INVALID_FEATURE_CODE
				: ((FeatureImpl) casFeat_revisionId).getCode();

		casFeat_pageId = jcas.getRequiredFeatureDE(casType, "pageId",
				"uima.cas.Integer", featOkTst);
		casFeatCode_pageId = (null == casFeat_pageId) ? JCas.INVALID_FEATURE_CODE
				: ((FeatureImpl) casFeat_pageId).getCode();

		casFeat_contributorName = jcas.getRequiredFeatureDE(casType,
				"contributorName", "uima.cas.String", featOkTst);
		casFeatCode_contributorName = (null == casFeat_contributorName) ? JCas.INVALID_FEATURE_CODE
				: ((FeatureImpl) casFeat_contributorName).getCode();

		casFeat_comment = jcas.getRequiredFeatureDE(casType, "comment",
				"uima.cas.String", featOkTst);
		casFeatCode_comment = (null == casFeat_comment) ? JCas.INVALID_FEATURE_CODE
				: ((FeatureImpl) casFeat_comment).getCode();

		casFeat_contributorId = jcas.getRequiredFeatureDE(casType,
				"contributorId", "uima.cas.Integer", featOkTst);
		casFeatCode_contributorId = (null == casFeat_contributorId) ? JCas.INVALID_FEATURE_CODE
				: ((FeatureImpl) casFeat_contributorId).getCode();

		casFeat_timestamp = jcas.getRequiredFeatureDE(casType, "timestamp",
				"uima.cas.Long", featOkTst);
		casFeatCode_timestamp = (null == casFeat_timestamp) ? JCas.INVALID_FEATURE_CODE
