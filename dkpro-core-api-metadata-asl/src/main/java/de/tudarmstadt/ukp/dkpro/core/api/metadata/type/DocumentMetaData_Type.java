 ...
 * @generated
 */
public class DocumentMetaData_Type
    extends DocumentAnnotation_Type
{
    ...
    private final FSGenerator fsGenerator = new FSGenerator()
    {
        ...
        public FeatureStructure createFS(int addr, CASImpl cas)
        {
            if (DocumentMetaData_Type.this.useExistingInstance) {
                ...
                return new DocumentMetaData(addr, DocumentMetaData_Type.this);
            }
        }
    };
    /** @generated */
    ...
    public final static boolean featOkTst = JCasRegistry
            .getFeatOkTst("de.tudarmstadt.ukp.dkpro.core.api.metadata.type.DocumentMetaData");
    ...
    public String getDocumentBaseUri(int addr)
    {
        if (featOkTst && casFeat_documentBaseUri == null) {
            jcas.throwFeatMissing("documentBaseUri",
                    "de.tudarmstadt.ukp.dkpro.core.api.metadata.type.DocumentMetaData");
        }
    ...
    public boolean getIsLastSegment(int addr)
    {
        if (featOkTst && casFeat_isLastSegment == null) {
            jcas.throwFeatMissing("isLastSegment",
                    "de.tudarmstadt.ukp.dkpro.core.api.metadata.type.DocumentMetaData");
        }
    ...
    public DocumentMetaData_Type(JCas jcas, Type casType)
    {
        ...
        casFeat_documentBaseUri = jcas.getRequiredFeatureDE(casType, "documentBaseUri",
                "uima.cas.String", featOkTst);
        casFeatCode_documentBaseUri = (null == casFeat_documentBaseUri) ? JCas.INVALID_FEATURE_CODE
                : ((FeatureImpl) casFeat_documentBaseUri).getCode();

        casFeat_isLastSegment = jcas.getRequiredFeatureDE(casType, "isLastSegment",
                "uima.cas.Boolean", featOkTst);
        casFeatCode_isLastSegment = (null == casFeat_isLastSegment) ? JCas.INVALID_FEATURE_CODE
                : ((FeatureImpl) casFeat_isLastSegment).getCode();
