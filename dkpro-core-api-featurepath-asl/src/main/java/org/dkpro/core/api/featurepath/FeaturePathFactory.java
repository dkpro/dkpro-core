...
public class FeaturePathFactory
{
    ...
    /**
     * Select annotation/value pairs matching the given feature path. The path has to start with a
     * fully qualified type name followed by a feature path. This function can be used in extended
     * for-loops.
     *
     * @param <T>
     *            the anchor type.
     * @param aJCas
     *            the JCas to search in.
     * @param aAnchor
     *            the anchor type.
     * @param aPath
     *            a feature path relative to the anchor type.
     * @return annotation/value pairs.
     * @throws FeaturePathException
     *             if an error occurs during initialization of the feature path
     */
    public static <T extends Annotation> Iterable<Entry<T, String>> select(JCas aJCas,
