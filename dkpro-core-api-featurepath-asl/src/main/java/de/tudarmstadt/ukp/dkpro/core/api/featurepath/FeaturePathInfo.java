 ...
 *
 * FeaturePathInfo implementation validates the given featurePath for a specified annotation. It can
 * return the featurePath value as string or match the featurePath value against a specified
 * condition.
 */
public class FeaturePathInfo
{
    ...
    /**
     * Initialize the object's featurePath for the given type. If the featurePath is not valid an
     * exception is thrown.
     *
     * @param featurePath
     *            featurePath string separated by "/"
     ...
     *             if an error occurs during initialization of the feature path
     */
    public void typeSystemInit(Type featurePathType) throws FeaturePathException
    {
     ...
     *
     * @see
     * org.apache.uima.annotator.dict_annot.dictionary.impl.FeaturePathInfo#getValue(org.apache.uima
     * .cas.text.AnnotationFS)
     */
     ...
     *
     * @see
     * org.apache.uima.annotator.dict_annot.dictionary.impl.FeaturePathInfo#match(org.apache.uima.
     * cas.text.AnnotationFS, org.apache.uima.annotator.dict_annot.impl.Condition)
     */
    public boolean match(AnnotationFS annotFS, Condition condition)
    {
        ...
        if (this.featurePathElementNames.size() == 0) {
            ...
            for (int i = 0; i < this.featurePathElementNames.size(); i++) {
                ...
                switch (currentFeatureTypeCode) {
                case LowLevelCAS.TYPE_CLASS_STRING:
                    checkCondidtion = checkString(currentFS.getStringValue(feature), condition);
                    noFurtherElementsPossible = true;
                    break;
                case LowLevelCAS.TYPE_CLASS_INT:
                    checkCondidtion = checkInt(currentFS.getIntValue(feature), condition);
                    noFurtherElementsPossible = true;
                    break;
                case LowLevelCAS.TYPE_CLASS_BOOLEAN:
                    checkCondidtion = checkBoolean(currentFS.getBooleanValue(feature), condition);
                    noFurtherElementsPossible = true;
                    break;
                case LowLevelCAS.TYPE_CLASS_BYTE:
                    checkCondidtion = checkByte(currentFS.getByteValue(feature), condition);
                    noFurtherElementsPossible = true;
                    break;
                case LowLevelCAS.TYPE_CLASS_DOUBLE:
                    checkCondidtion = checkDouble(currentFS.getDoubleValue(feature), condition);
                    noFurtherElementsPossible = true;
                    break;
                case LowLevelCAS.TYPE_CLASS_FLOAT:
                    checkCondidtion = checkFloat(currentFS.getFloatValue(feature), condition);
                    noFurtherElementsPossible = true;
                    break;
                case LowLevelCAS.TYPE_CLASS_LONG:
                    checkCondidtion = checkLong(currentFS.getLongValue(feature), condition);
                    noFurtherElementsPossible = true;
                    break;
                case LowLevelCAS.TYPE_CLASS_INVALID:
                    noFurtherElementsPossible = true;
                    ...
                    break;
                case LowLevelCAS.TYPE_CLASS_SHORT:
                    checkCondidtion = checkShort(currentFS.getShortValue(feature), condition);
                    noFurtherElementsPossible = true;
                    break;
                case LowLevelCAS.TYPE_CLASS_FS:
                    currentFS = currentFS.getFeatureValue(feature);
