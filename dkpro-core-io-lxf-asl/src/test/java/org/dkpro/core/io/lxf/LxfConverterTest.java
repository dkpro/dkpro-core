...
public class LxfConverterTest
{
        ...
        throws Exception
    {
        ...
        test("src/test/resources/lxf/text-sentence/orig.lxf", false, ids);
    }
    ...
    public void testSentenceDelta()
        throws Exception
    {
        test("src/test/resources/lxf/text-sentence/orig.lxf", true, null);
    }
        ...
        throws Exception
    {
        ...
        test("src/test/resources/lxf/text-sentence-tokens/orig.lxf", false, ids);
    }
    ...
    public void testTokenDelta()
        throws Exception
    {
        test("src/test/resources/lxf/text-sentence-tokens/orig.lxf", true, null);
    }
        ...
        throws Exception
    {
        ...
        test("src/test/resources/lxf/text-sentence-tokens-morpho/orig.lxf", false, ids);
    }
    ...
    public void testDepDelta()
        throws Exception
    {
        test("src/test/resources/lxf/text-sentence-tokens-morpho-dep/orig.lxf", true, null);
    }
        ...
        throws Exception
    {
        ...
        test("src/test/resources/lxf/text-sentence-tokens-morpho-dep/orig.lxf", false, ids);
    }
    ...
    public void testMorphoDelta()
        throws Exception
    {
        test("src/test/resources/lxf/text-sentence-tokens-morpho/orig.lxf", true, null);
    }
