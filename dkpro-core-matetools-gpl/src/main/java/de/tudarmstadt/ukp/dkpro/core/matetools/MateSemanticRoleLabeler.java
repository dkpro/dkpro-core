 ...
 * <p>
 * Please cite the following paper, if you use the semantic role labeler Anders Björkelund, Love
 * Hafdell, and Pierre Nugues. Multilingual semantic role labeling. In Proceedings of The Thirteenth
 * Conference on Computational Natural Language Learning (CoNLL-2009), pages 43--48, Boulder, June
 * 4--5 2009.
 * </p>
 */
    ...
    extends JCasAnnotator_ImplBase
{
        ...
        throws AnalysisEngineProcessException
    {
        ...
        case "en":
            ...
            break;
        case "zh":
            Language.setLanguage(L.chi);
            break;
        case "es":
            Language.setLanguage(L.spa);
            break;
        default:
        ...
        for (Sentence s : JCasUtil.select(jcas, Sentence.class)) {
            ...
            se.lth.cs.srl.corpus.Sentence sen = se.lth.cs.srl.corpus.Sentence
                    .newDepsOnlySentence(NEWLINE_PATTERN.split(conll2009String));
            ...
            for (Predicate pred : preds) {
                ...
                SemPred semanticPredicate = new SemPred(jcas, predToken.getBegin(),
                        predToken.getEnd());
        ...
        for (Row row : ctokens.values()) {
            ...
            conll2009String.append(
                    String.format("%d\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\n",
                            id, form, lemma, plemma, pos, ppos, feat, pfeat, head, phead, deprel,
