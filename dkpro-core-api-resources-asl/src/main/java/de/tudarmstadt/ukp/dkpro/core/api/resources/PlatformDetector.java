...
public class PlatformDetector
{
     ...
     *
     * @param aOs
     *            an OS name as could be found in the os.name system property.
     */
    public void setOs(final String aOs)
    {
     ...
     *
     * @return {@literal "windows"}, {@literal "osx"}, {@literal "linux"} or {@literal "solaris"}.
     */
    public String getOs()
    {
        return _os;
     ...
     *
     * @param aArch
     *            {@literal "big-endian"} for PowerPC or Sparc systems or {@literal "little-endian"}
     *            for x86 systems.
     */
    public void setArch(final String aArch)
    {
    ...
    /**
     * Set the byte order. TreeTagger models are sensitive to the byte order. This should only be
     * used in test cases.
     *
     * @param aByteOrder
     *            the byte order.
     */
    public void setByteOrder(final ByteOrder aByteOrder)
    {
    ...
    /**
     * Get the platform ID which is {@link #getOs()} and {@link #getArch()} separated by a
     * {@literal "-"} (dash).
     *
    ...
    public void updatePlatform(final String aOs, final String aArch, final ByteOrder aByteOrder)
    {
        ...
        if (_arch.equals("x86") || _arch.equals("i386") || _arch.equals("i486")
                || _arch.equals("i586") || _arch.equals("i686")) {
            _arch = ARCH_X86_32;
        }
        if (_arch.equals("amd64")) {
            _arch = ARCH_X86_64;
        }
    ...
    /**
     * Get the {@literal chmod} (change permissions) command for the current platform (if one is
     * necessary).
     *
