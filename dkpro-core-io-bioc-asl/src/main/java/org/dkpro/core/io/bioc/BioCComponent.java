...
public interface BioCComponent
{
    ...
    // DKPro Core constants
    String FEAT_REL_TARGET = Dependency._FeatName_Dependent;
    String FEAT_REL_SOURCE = Dependency._FeatName_Governor;
    ...
    static Type guessBestRelationType(TypeSystem aTypeSystem, Map<String, String> aInfons)
    {
        ...
        // DKPro Core currently has no basic relation layer name as INCEpTION does
    ...
    static Type guessBestSpanType(TypeSystem aTypeSystem, Map<String, String> aInfons)
    {
        ...
        // DKPro Core currently has no basic span layer name as INCEpTION does
    ...
    public static void transferFeatures(AnnotationFS aAnnotation, Map<String, String> aInfons)
    {
        ...
        // DKPro Core currently has no basic feature name as INCEpTION does
