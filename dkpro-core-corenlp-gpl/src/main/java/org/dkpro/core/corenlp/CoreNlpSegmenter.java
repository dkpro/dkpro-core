    ...
    extends SegmenterBase
{
    ...
    public void initialize(UimaContext aContext) throws ResourceInitializationException
    {
        ...
        tokenizerAnnotator = new ModelProviderBase<TokenizerAnnotator>(this, "corenlp", "tokenizer")
        {
            {
                setDefault(LOCATION,
                        "classpath:/de/tudarmstadt/ukp/dkpro/core/corenlp/lib/tokenizer-${language}-${variant}.properties");
            }
            ...
            protected TokenizerAnnotator produceResource(URL aUrl) throws IOException
            {
                ...
                NewlineIsSentenceBreak breakNL = WordToSentenceProcessor
                        .stringToNewlineIsSentenceBreak(newlineIsSentenceBreak);
        ...
        sentenceAnnotator = new ModelProviderBase<WordsToSentencesAnnotator>(this, "corenlp",
                "sentence")
        {
            {
