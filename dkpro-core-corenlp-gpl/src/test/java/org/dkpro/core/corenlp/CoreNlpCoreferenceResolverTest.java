...
public class CoreNlpCoreferenceResolverTest
{
    ...
    public void test() throws Exception
    {
        ...
        String[][] ref = { { "John", "He" }, { "a car", "it" } };

        AssertAnnotations.assertCoreference(ref, select(jcas, CoreferenceChain.class));
    }

    @Test
    public void testDictionarySieve() throws Exception
    {
        JCas jcas = runTest("en",
                "John joined Google in 2012. He is doing research for the company.",
                Constants.SIEVEPASSES + ",CorefDictionaryMatch");

        String[][] ref = new String[][] { { "John", "He" }, { "Google", "the company" },
                { "2012" } };
    ...
    @Test
    public void testTriggerReparse() throws Exception
    {
        JCas jcas = runTest("en", "'Let's go! I want to see the Don', he said.");

        String[][] ref = { { "Let" }, { "go" }, { "I" }, { "the Don'", "he" } };
    ...
    public void testTriggerReparse1() throws Exception
    {
        JCas jcas = runTest("en",
        ...
        String[][] ref = { { "Other major domestic initiatives in his presidency" },
                { "his presidency" }, { "his" },
                ...
                { "the Patient Protection and Affordable Care Act" }, { "the Patient Protection" },
                { "Affordable Care Act" },
                ...
                { "2010" }, { "the Budget Control Act of 2011" },
                { "the American Taxpayer Relief Act of 2012" }, { "2011" }, { "2012" } };
    ...
    private JCas runTest(String aLanguage, String aText, String aSieves) throws Exception
    {
        ...
        AnalysisEngine engine = createEngine(createEngineDescription(
                ...
                createEngineDescription(CoreNlpParser.class, CoreNlpParser.PARAM_WRITE_CONSTITUENT,
                        true, CoreNlpParser.PARAM_WRITE_DEPENDENCY, true,
