...
public class CoreNlpPosTaggerTest
{
    ...
    @Test
    public void testEnglishExtra() throws Exception
    {
    ...
    {
        runTest("de", "Das ist ein Test .", new String[] { "PDS", "VAFIN", "ART", "NN", "$." },
    ...
    public void testFrench() throws Exception
    {
        ...
        String[] posMapped = { "POS_PRON", "POS_VERB", "POS_NOUN", "POS_ADP", "POS_DET", "POS_NOUN",
                "POS_ADP", "POS_NOUN", "POS_ADV", "POS_ADJ", "POS_PUNCT", "POS_PRON", "POS_VERB",
    ...
    public void testChinese() throws Exception
    {
        ...
        runTest("zh", "尾 舵 常 处于 风轮 后面 的 尾流 区里 。",
                ...
                new String[] { "POS_NOUN", "POS_NOUN", "POS_ADJ", "POS_VERB", "POS_NOUN",
                        "POS_NOUN", "POS_PART", "POS_NOUN", "POS_NOUN", "POS_PUNCT" });
        ...
        runTest("zh", "服务业 成为 广东 经济 转型 升级 的 重要 引擎 。",
                ...
                new String[] { "POS_NOUN", "POS_VERB", "POS_PROPN", "POS_NOUN", "POS_VERB",
                        "POS_VERB", "POS_PART", "POS_ADJ", "POS_NOUN", "POS_PUNCT" });
    ...
    private JCas runTest(String aLanguage, String aVariant, String aText) throws Exception
    {
        ...
        AnalysisEngine engine = createEngine(CoreNlpPosTagger.class, CoreNlpPosTagger.PARAM_VARIANT,
                aVariant, CoreNlpPosTagger.PARAM_PRINT_TAGSET, true);
