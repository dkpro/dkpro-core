...
import de.tudarmstadt.ukp.dkpro.core.api.segmentation.type.Compound.RECURSIVE_SPLIT_LEVEL;
...
public class CompoundTest
{
	...
	public void testAll()
		...
		assertThat(coveredTextArrayFromAnnotations(compound.getSplitsWithoutMorpheme(RECURSIVE_SPLIT_LEVEL.ALL)),
				is(splitsList));
	...
	public void testLowest()
		...
		assertThat(coveredTextArrayFromAnnotations(compound.getSplitsWithoutMorpheme(RECURSIVE_SPLIT_LEVEL.LOWEST)),
				is(splitsList));
	...
	public void testHighest()
		...
		assertThat(coveredTextArrayFromAnnotations(compound.getSplitsWithoutMorpheme(RECURSIVE_SPLIT_LEVEL.HIGHEST)),
				is(splitsList));
	...
	public void testNone()
		...
		assertThat(coveredTextArrayFromAnnotations(compound.getSplitsWithoutMorpheme(RECURSIVE_SPLIT_LEVEL.NONE)),
				is(splitsList));
